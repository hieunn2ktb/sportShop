                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <form:form method="post" action="/admin/product/update" class="row"
                                                enctype="multipart/form-data" modelAttribute="newProduct" onsubmit="return validateForm()">
                                                <c:set var="errorName">
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <form:select class="form-select" path="brand">
                                                        <form:option value="" label="-- Chọn brand --"/>
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <form:select class="form-select" path="category.id" id ="category">
